...
// Sigh, 
// DemoSauce:170: error: variable or field 'startAnimation' declared void
//  void startAnimation( BaseAnimation *newAnim ) {
// isn't fixed by:
// #include "BaseAnimation.h"
// That include needs to be put in fulldemo.ino where it does not belong :(
