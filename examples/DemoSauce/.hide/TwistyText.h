...
void TwistyText::init( Adafruit_ILI9341 tft ) {
...
void TwistyText::reset( Adafruit_ILI9341 tft ) {
...
void TwistyText::perFrame( Adafruit_ILI9341 tft, FrameParams frameParams ) {
