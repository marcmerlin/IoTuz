...
void TransitionHalftone::init( Adafruit_ILI9341 tft ) {

}

void TransitionHalftone::restart( Adafruit_ILI9341 tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame( Adafruit_ILI9341 tft, FrameParams frameParams ) {
